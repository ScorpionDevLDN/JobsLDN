$(function() {
  ...
  if (select2Select.length > 0) {
    ...
    $(".select2-selection__arrow").append(
      '<img src="../../jobsldn/images/icons/arrow-right.svg" class="arrow" alt="Arrow Right">'
    );
    $(".search-filter .select2-selection__arrow").append(
      '<img src="../../jobsldn/images/icons/arrow-right-gray.svg" class="arrow filter" alt="Arrow Right">'
    );
  }
  // Salary Range
