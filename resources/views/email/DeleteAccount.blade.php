                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    ...
                                    <br>
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                        You have recently made a request OR deleted your account with us,
                                        ...
                                        This is a confirmation email to say that all your personal data has been deleted from our database.
                                    </p>

                                    <br>
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                        If you did not make this request, please notify us as soon as possible and sign-up again!
                                    </p>
                                    <br>
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                        Best,
