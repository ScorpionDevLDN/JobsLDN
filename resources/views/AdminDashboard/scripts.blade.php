...
<script type="text/javascript" src="{{asset('assets/plugins/custom/prismjs/prismjs.bundle.js')}}"></script>
...
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<script type="text/javascript" src="{{asset('assets/js/pages/crud/forms/editors/summernote.js')}}"></script>
