            ...
            <div class="modal-body">
                <form enctype="multipart/form-data" class="px-0" action="{{route('company-jobs.store')}}" method="post">
                    ...
                    <div class="row gap-50">
                        ...
                        <div class="col-12 col-lg-6">
                            <select class="select-2-select  w-100" name="currency_id" required>
                        ...
                        <div class="col-12">
                            <select class="select-2-select" name="per_id" required>
                        ...
                        <div class="col-12">
                            <select class="select-2-select  w-100" name="type_id" required>
                        ...
                        <div class="col-12">
                            <select class="select-2-select  w-100" name="category_id" required>
                        ...
                        <div class="col-12">
                            <select class="select-2-select  w-100" name="city_id" required>
