        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-block d-xl-none">
                        <a class="nav-link {{$menu == 'myBookmarks' ? 'active' : ''}}" href="{{route('myBookmarks')}}">Bookmarks</a>
                    </li>
                    <li class="nav-item d-block d-xl-none">
                ...
                <div class="header-button d-none d-xl-block">
                    ...
                    @elseif(auth('companies')->check())
                        <a href="#" data-bs-toggle="modal" data-bs-target="#post-job" class="button outline">Post a job</a>
                    @endif
                </div>
