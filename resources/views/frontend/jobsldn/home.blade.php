...
@section('content')
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-4">
                                                        <div class="icon-box wow animate animate__fadeInUp">
                                                            <div class="icon">
                                                                <img src="{{asset('jobsldn/images/icons/ic-actions-emultiple-edit.svg')}}"
                                                                     alt="Icon">
                                                            </div>
                                                            <div class="content">
                                                                <h6>{{$posts_count}}</h6>
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="icon-box wow animate animate__fadeInUp">
                                                            <div class="icon">
                                                                <img src="{{asset('jobsldn/images/icons/ic-actions-bag.svg')}}"
                                                                     alt="Icon">
                                                            </div>
                                                            <div class="content">
                                                                <h6>{{$companies}}</h6>
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="icon-box wow animate animate__fadeInUp">
                                                            <div class="icon">
                                                                <img src="{{asset('jobsldn/images/icons/ic-folder-user.svg')}}"
                                                                     alt="Icon">
                                                            </div>
                                                            <div class="content">
                                                                <h6>{{$job_seekers}}</h6>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            ...
                            <div class="job-box featured wow animate animate__fadeInDown animation-delay-1">
                                <div class="featured-icon">
                                    <img src="{{asset('jobsldn/images/icons/featured-job.svg')}}" alt="Featured Icon">
                                </div>
                                ...
                                <a href="{{route('job_details',$post->id)}}" class="button  text-center more-details">More
                                    Details</a>
                            </div>
    ...
    @include('frontend.jobsldn.app.cta')
@endsection