                ...
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-lg-9">
                        <div class="row gap-50">
                            ...
                            <div class="col-12 col-lg-6">
                                <input value="{{old('salary')}}" type="text" name="salary" placeholder="Salary*"
                            ...
                            <div class="col-12 col-lg-6 position-relative">
                                <input value="{{old('expired_at')}}" class="form-control date" name="expired_at"
