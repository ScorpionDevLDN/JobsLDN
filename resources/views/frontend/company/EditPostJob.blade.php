                ...
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-lg-9">
                        <div class="row gap-50">
                            ...
                            <div class="col-12">
                                <label for="summary" class="floating-label" style="color:#2923ff;">Summary *</label>
                            ...
                            <div class="col-12">
                                <div class="pdf-upload-btn custom-upload file">
                                    <label
                                            ...
                                            for="client_form_file_2" data-element="custom-upload-button">
                                    ...
                                    <input class="custom-upload__input" name="pdf_details" accept=".pdf"
                                           id="client_form_file_2" type="file" data-behaviour="custom-upload-input">
                                ...
                                @if($job->pdf_details)
                                    <embed src="{{asset('storage/'.$job->pdf_details)}}" type="application/pdf" width="100%" height="100%">
                                @endif
                            </div>
                        </div>
                        <hr>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-lg-9">
                        <div class="row gap-50">
                            ...
                            <div class="col-12 col-lg-6">
                                <input value="{{$job->salary ?? old('salary')}}" name="salary" placeholder="Salary*"
                            ...
                            <div class="col-12 col-lg-6 position-relative">
                                <input disabled value="{{$job->expired_at->toDateString() ?? old('expired_at')}}" class="form-control date" name="expired_at"
                                       type="text" id="example-date-input">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-7">
                                            ...
                                            <p class="checkboxes d-inline">
                                                <input {{$job->is_super_post ? 'checked' : ''}} id="check_11" type="checkbox" name="is_super_post" value="1">
                                                <label for="check_11">
