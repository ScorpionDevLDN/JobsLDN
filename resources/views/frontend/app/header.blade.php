                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item d-block d-xl-none">
                            <a href="#" class="button outline" data-bs-toggle="modal" data-bs-target="#post-job">Post a
                                job</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            @php $title = \App\Models\DynamicPage::query()->accepted()->whereIn('shown_in',[1,2])->first()->title; @endphp
