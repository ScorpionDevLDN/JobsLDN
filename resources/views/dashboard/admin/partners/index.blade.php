...
@section('breadcrumb')
    <a href="{{route('admin.partners.index')}}" class="btn">Partners</a>
@endsection
                ...
                <div class="card-toolbar">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <form enctype="multipart/form-data" action="{{route('admin.partners.store')}}" method="post">
                                @csrf
                ...
                <table id="tableToExcel" class="table responsive" cellspacing="0" width="100%">
                    ...
                    @foreach($partners as $partner)
                        <tr>
                            ...
                            <td><img class="mr-5" width="50px" src="{{$partner->image}}" alt="">{{$partner->name}}</td>
                            <td>{{substr($partner->link,0,20)}}</td>
                            <td>
                                <div class="row">
                                    <div class="col-1 pr-10" style="margin-left: -10px;">
                                        <div class="pretty p-icon p-toggle p-plain btn btn-light-info btn-icon">
                                            <input name="status" data-id="{{$partner->id}}" class="toggle-class"
                                                   type="checkbox" {{ $partner->status ? 'checked' : '' }}>
                                    ...
                                    <div class="col-1 pr-10">
                                        <a href="#" class="btn btn-light-primary font-weight-bold btn-icon"
                                           data-toggle="modal"
                                           data-target="#exampleModalEdit{{$partner->id}}">
        ...
        <rect fill="#000000" opacity="0.3" x="5" y="20" width="15" height="2" rx="1"/>
                                    ...
                                    <div class="col-1">
                                        <a href="#" class="btn btn-light-danger btn-icon font-weight-bold" data-toggle="modal"
                                           data-target="#exampleModalDelete{{$partner->id}}">
                        ...
                        <!-- Modal-->
                        <div class="modal fade" id="exampleModalEdit{{$partner->id}}" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form enctype="multipart/form-data" action="{{route('admin.partners.update',$partner->id)}}" method="post">
                                    @method('put')
                                    @csrf
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Name
                                                    <span class="text-danger">*</span></label>
                                                <input required value="{{$partner->name}}" type="text" name="name"
                                                       class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input name="image" type="file" class="custom-file-input" id="customFile">
                                                    <label class="custom-file-label" for="customFile">Choose file</label>
                                                    <img class="my-5" width="50px" src="{{$partner->image}}" alt="">
                                                    <span class="text-danger">@error('image'){{ $message }}@enderror</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Link
                                                    <span class="text-danger">*</span></label>
                                                <input required value="{{$partner->link}}" type="text" name="link"
                                                       class="form-control"
                        ...
                        <!--end::Button-->
                        <!-- Modal-->
                        <div class="modal fade" id="exampleModalDelete{{$partner->id}}" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input readonly value="{{$partner->name}}" type="text" name="name"
                                                       class="form-control"
                                                       placeholder="Enter partner name"/>
                                            </div>
                                        </div>
