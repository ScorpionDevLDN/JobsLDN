                        ...
                        <div class="login-form login-signin py-1">
                            ...
                            <form id="login-form" class="form" action="{{ route('admin.check') }}" method="post">
                                ...
                                <div class="form-group">
                                    <div class="d-flex justify-content-between mt-n5">
                                        ...
                                        <a href="{{route('admin.forget.password.get')}}" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5" id="kt_login_forgot">Forgot Password ?</a>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="text-center pt-2">
                                    <button id="kt_login_signin_submit" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">Sign In
                                    </button>
                                </div>
                                <!--end::Action-->
                            </form>
