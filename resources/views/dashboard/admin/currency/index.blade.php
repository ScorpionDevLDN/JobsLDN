...
@section('content')
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-title">
                    <h3 class="card-label">Currencies
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label>Currency Symbol
                                                <span class="text-danger">*</span></label>
                                            <input required type="text" name="symbol" class="form-control"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" opacity="0.3" x="5" y="20" width="15" height="2" rx="1"/>
                        ...
                        <!-- Modal-->
                        <div class="modal fade" id="exampleModalEdit{{$currency->id}}" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>currency Name
                                                    <span class="text-danger">*</span></label>
                                                <input required value="{{$currency->name}}" type="text" name="name"
                                                       class="form-control"
                                                       placeholder="Enter currency name"/>
                                            </div>
                                            <div class="form-group">
                                                <label>currency Code
                                                    <span class="text-danger">*</span></label>
                                                <input required value="{{$currency->code}}" type="text" name="code"
                                                       class="form-control"
                                                       placeholder="Enter currency code"/>
                                            </div>
                                            <div class="form-group">
                                                <label>Currency Symbol
                                                    <span class="text-danger">*</span></label>
                                                <input required value="{{$currency->symbol}}" type="text" name="symbol"
                                                       class="form-control"
                                                       placeholder="Enter currency symbol"/>
                                            </div>
                                        </div>
                        ...
                        <!--end::Button-->
                        <!-- Modal-->
                        <div class="modal fade" id="exampleModalDelete{{$currency->id}}" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form action="{{route('admin.currencies.destroy',$currency->id)}}" method="post">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Are You sure to delete currency? <span
                                                            class="text-danger">*</span></label>
                                                <input readonly value="{{$currency->name}}" type="text" name="name"
                                                       class="form-control"
                                                       placeholder="Enter currency name"/>
                                            </div>
                                        </div>
