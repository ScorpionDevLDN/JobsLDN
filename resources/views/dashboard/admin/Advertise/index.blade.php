        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-title">
                    <h3 class="card-label">Advertises
                                ...
                                <div class="row">
                                    <div class="col-1 pr-10" style="margin-left: -10px;">
                                        <div class="pretty p-icon p-toggle p-plain btn btn-light-info btn-icon">
                                            <input name="status" data-id="{{$advertise->id}}" class="toggle-class"
                                                   type="checkbox" {{ $advertise->status ? 'checked' : '' }}>
                                    ...
                                    <div class="col-1 pr-10">
                                        <a href="#" class="btn btn-light-primary font-weight-bold btn-icon"
                                           data-toggle="modal"
                                           data-target="#exampleModalEdit{{$advertise->id}}">
        ...
        <rect fill="#000000" opacity="0.3" x="5" y="20" width="15" height="2" rx="1"/>
                                    ...
                                    <div class="col-1">
                                        <a href="#" class="btn btn-light-danger btn-icon font-weight-bold" data-toggle="modal"
                                           data-target="#exampleModalDelete{{$advertise->id}}">
                        ...
                        <!--end::Button-->
                        <!-- Modal-->
                        <div class="modal fade" id="exampleModalDelete{{$advertise->id}}" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
