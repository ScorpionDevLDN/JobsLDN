...
@section('content')
                ...
                <div class="card-toolbar">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <form action="{{route('admin.pers.store')}}" method="post">
                                @csrf
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Add Per</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="per" class="form-control"
                                                   placeholder="Enter per name"/>
                                        </div>
                                    </div>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" opacity="0.3" x="5" y="20" width="15" height="2" rx="1"/>
                        ...
                        <!-- Modal-->
                        <div class="modal fade" id="exampleModalEdit{{$per->id}}" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form action="{{route('admin.pers.update',$per->id)}}" method="post">
                                    @method('put')
                                    @csrf
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Edit Per</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>per Name
                                                    <span class="text-danger">*</span></label>
                                                <input required value="{{$per->per}}" type="text" name="per"
                                                       class="form-control"
                                                       placeholder="Enter per name"/>
                                            </div>
                                        </div>
                        ...
                        <!--end::Button-->
                        <!-- Modal-->
                        <div class="modal fade" id="exampleModalDelete{{$per->id}}" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form action="{{route('admin.pers.destroy',$per->id)}}" method="post">
                                    @method('delete')
                                    @csrf
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Delete per</h5>
                                            <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                <i aria-hidden="true" class="ki ki-close"></i>
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Are You sure to delete per? <span
                                                            class="text-danger">*</span></label>
                                                <input readonly value="{{$per->per}}" type="text" name="per"
                                                       class="form-control"
                                                       placeholder="Enter per name"/>
                                            </div>
                                        </div>
