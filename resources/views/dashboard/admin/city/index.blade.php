...
@section('breadcrumb')
    <a href="{{route('admin.cities.index')}}" class="btn">Job Settings</a>
    <a href="{{route('admin.cities.index')}}" class="btn">Cities</a>
@endsection
@section('title','City')
@section('content')
    <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-1 pr-10" style="margin-left: -10px;">
                                        <div class="pretty p-icon p-toggle p-plain btn btn-light-info btn-icon">
                                            <input name="status" data-id="{{$city->id}}" class="toggle-class"
                                                   type="checkbox" {{ $city->status ? 'checked' : '' }}>
                                    ...
                                    <div class="col-1 pr-10">
                                        <a href="#" class="btn btn-light-primary font-weight-bold btn-icon"
                                           data-toggle="modal"
                                           data-target="#exampleModalEdit{{$city->id}}">
        ...
        <rect fill="#000000" opacity="0.3" x="5" y="20" width="15" height="2" rx="1"/>
                                    ...
                                    <div class="col-1">
                                        <a href="#" class="btn btn-light-danger btn-icon font-weight-bold" data-toggle="modal"
                                           data-target="#exampleModalDelete{{$city->id}}">
                        ...
                        <!-- Modal-->
                        <div class="modal fade" id="exampleModalEdit{{$city->id}}" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                        ...
                        <!--end::Button-->
                        <!-- Modal-->
                        <div class="modal fade" id="exampleModalDelete{{$city->id}}" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form action="{{route('admin.cities.destroy',$city->id)}}" method="post">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Are You sure to delete city? <span
