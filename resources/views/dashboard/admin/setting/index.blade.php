                        ...
                        <div class="tab-content pt-3">
                            ...
                            <div class="tab-pane" id="kt_builder_page">
                                ...
                                <div class="col-12 px-10 d-flex mb-3 row pb-3">
                                    ...
                                    <div class="col-12 col-lg-9 px-2">
                                        <input name="main_color" class="form-control" type="color" value="{{$setting->main_color}}"
                                ...
                                <div class="col-12 px-10 d-flex mb-3 row pb-3">
                                    ...
                                    <div class="col-12 col-lg-9 px-2">
                                        <input name="secondary_color" class="form-control" type="color" value="{{$setting->secondary_color}}"
                                               id="example-color-input">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <button type="submit" name="builder_submit" data-demo="demo1"
                                        class="btn btn-primary font-weight-bold mr-2">Submit
                                </button>
