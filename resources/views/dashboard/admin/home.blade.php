        ...
        <div class="col-md-6 col-sm-4 mb-10">
            <div class="row">
                <div class="col-md-12 col-sm-4">
					...
					<span class="svg-icon svg-icon-dark svg-icon-3x menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Settings4.svg--><svg
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M12,15 C13.6568542,15 15,13.6568542 15,12 C15,10.3431458 13.6568542,9 12,9 C10.3431458,9 9,10.3431458 9,12 C9,13.6568542 10.3431458,15 12,15 Z"
              fill="#000000"/>
                                        ...
                                        <span class="text-dark">Admins</span>
                                    </a>
                                </div>
                                <div class="col-md-4 col-sm-4 mb-20">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M12,15 C13.6568542,15 15,13.6568542 15,12 C15,10.3431458 13.6568542,9 12,9 C10.3431458,9 9,10.3431458 9,12 C9,13.6568542 10.3431458,15 12,15 Z"
              fill="#000000"/>
                                        ...
                                        <span class="text-dark">Companies</span>
                                    </a>
                                </div>
                                <div class="col-md-4 col-sm-4 mb-20">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M12,15 C13.6568542,15 15,13.6568542 15,12 C15,10.3431458 13.6568542,9 12,9 C10.3431458,9 9,10.3431458 9,12 C9,13.6568542 10.3431458,15 12,15 Z"
              fill="#000000"/>
                                        ...
                                        <span class="text-dark">Job Seeker</span>
                                    </a>
                                </div>
                            </div>
                        </div>
