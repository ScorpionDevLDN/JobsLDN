                                    ...
                                    <div class="col-1 pr-10" style="margin-left: -10px;">
                                        <a href="#" class="btn btn-light-info font-weight-bold btn-icon"
                                           ...
                                           data-target="#exampleModalShow{{$job->id}}">
                                            <span class="svg-icon svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Info-circle.svg--><svg
