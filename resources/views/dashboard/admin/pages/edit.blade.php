        ...
        <div class="row">
            <div class="col-10">
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form enctype="multipart/form-data" action="{{route('admin.pages.update',$dynamicPage->id)}}" method="post">
                        @method('put')
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input value="{{$dynamicPage->title}}"  name="title" class="form-control" type="text"  id="example-text-input">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <textarea id="content" rows='8' name="content" placeholder="description"
                                      class="form-control">{{$dynamicPage->content}}</textarea>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input value="{{$dynamicPage->slug}}"  name="slug" class="form-control" type="text"  id="example-text-input">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input value="{{$dynamicPage->metadata}}"  name="metadata" class="form-control" type="text"  id="example-text-input">
                                </div>
                            </div>
